...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta name="author" content="Cristiano Ap Lázaro">
    ...
    <body id="page-top">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{route('veiculos.index')}}">Automóveis</a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $usuario->nome; ?></span>
                                    <img class="img-profile rounded-circle" src="{{URL::asset('assets/img/usuario.png')}} ">
                ...
                <div class="modal-content">
                    ...
                    <form id="form-perfil" method="POST" action="{{route('admin.editar', $id_usuario)}} ">
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label >Usuário</label>
                                        <input value="{{$usuario->usuario}} " type="text" class="form-control" id="usuario" name="usuario" placeholder="Usuário">
                                    </div>
        ...
        <script src="{{URL::asset('assets/js/mascaras.js')}}"></script>
